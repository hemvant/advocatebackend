...
const ENTITY_TYPES = Object.freeze(['CLIENT', 'CASE', 'HEARING', 'DOCUMENT', 'COURT', 'EMPLOYEE', 'INVOICE', 'AI_USAGE']);
const ACTION_TYPES = Object.freeze(['CREATE', 'UPDATE', 'DELETE', 'ASSIGN', 'LOGIN', 'MODULE_CHANGE', 'NOTIFY', 'EXTRACT', 'CASE_SUMMARY', 'DRAFT']);

const ENTITY_TO_MODULE = { CLIENT: 'CLIENTS', CASE: 'CASES', HEARING: 'HEARINGS', DOCUMENT: 'DOCUMENTS', COURT: 'COURTS', EMPLOYEE: 'EMPLOYEES', INVOICE: 'BILLING', AI_USAGE: 'AI' };
